...
function timelineFramesInBox(startX: number, currentX: number) {
  ...
  return allAnimationFrames(tracks).filter(frame => {
    const x = (frame - 1) / 249 * rect.width;
