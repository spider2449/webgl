...
Status: collections, bounded texture painting and local texture management are implemented; see [collections](2026-09-14-collections.md), [texture painting](2026-09-14-texture-painting.md) and [texture management](2026-09-14-texture-management.md). Object-wide Linear, Constant and Smooth animation interpolation is also implemented; see [animation interpolation](2026-09-14-animation-interpolation.md). Single-key selection, move and copy are implemented; see [keyframe timing](2026-09-14-keyframe-timing.md). Bounded linked instances are implemented for ordinary meshes; see [linked instances](2026-09-22-linked-instances.md). Scalar Location and Scale key-channel editing is implemented; see [scalar animation channels](2026-09-22-scalar-animation-channels.md). Rotation X/Y/Z key-channel editing is also implemented on the unwrapped Euler key metadata; see [rotation animation channels](2026-09-22-rotation-animation-channels.md). Legacy per-channel Linear/Constant/Smooth interpolation overrides remain supported as project/API fallback metadata; see [per-channel interpolation](2026-09-22-per-channel-interpolation.md). The Graph Editor is now the sole animation editing UI and provides direct channel selection, per-key outbound Constant/Linear/Bezier interpolation, editable Bezier tangents, scalar value dragging, transform-key move/Alt-drag copy, and playhead display; see [Graph Editor key curves and tangents](2026-09-22-graph-editor-view.md). Sculpting, node-based materials, independent per-channel key times and arbitrary F-curves remain open.
